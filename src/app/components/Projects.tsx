  ...
  const missionProjects = [
    {
      ...
      title: 'MCM',
      icon: Heart,
      image: '/assets/mcmulher.jpg',
      description: 'Mulheres Cristãs em Missão - MCM. Organização missionária para mulheres a partir de 17 anos, voltada ao cumprimento da Grande Comissão, ao crescimento integral da mulher e ao fortalecimento do lar e das organizações missionárias cristãs.',
    ...
    },
    {
      ...
      title: 'UMBB',
      icon: Users,
      image: '/assets/umbb.jpg',
      description: 'A sigla UMBB refere-se à União Missionária de Homens Batistas do Brasil (UMHBB), uma organização que busca integrar e engajar homens, jovens e meninos batistas em atividades missionárias e no crescimento espiritual.',
    ...
    },
    {
      ...
      title: 'MR',
      icon: Globe,
      image: '/assets/mrei.jpg',
      description: 'Mensageiras do Rei (MR) é uma organização missionária batista para meninas de 9 a 16 anos, voltada à educação cristã, formação moral e prática das missões, incentivando-as a viver e testemunhar Cristo.',
      details: 'Projeto focado em missões e serviço comunitário.',
      activities: ['Missões na cidade', 'Levando as boas novas', 'Discipulada meninas', 'Treinamentos'],
    },
    {
      id: 7,
      title: 'Amigos de Missões',
      icon: HandHeart,
      image: '/assets/amigos-de-missoes.jpg',
      description: 'Amigos de Missões é uma organização missionária infantil que oferece experiências cristãs de ensino e aprendizagem, ajudando as crianças a crescerem espiritualmente e a conhecerem e se envolverem com a obra missionária.',
      details: 'Ensinando as crianças a serem amigos de missões e integros.',
    ...
    },
    {
      ...
      icon: Crown,
      image: '/assets/erei.jpg',
      description: 'Embaixadores do Rei (ER) é uma organização missionária batista para meninos de 9 a 17 anos, voltada ao desenvolvimento físico, moral e espiritual, formando representantes de Cristo comprometidos com oração, missão, Bíblia e serviço.',
