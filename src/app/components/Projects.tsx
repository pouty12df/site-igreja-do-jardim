...
export function Projects() {
  const sportsProjects = [
    ...
    },
    {
      id: 2,
      title: 'Funcional',
      image: 'src/assets/funcional.jpg',
  ...
  const missionProjects = [
    ...
    },
    {
      ...
      icon: HandHeart,
      image: 'src/assets/AMIGOs DE MISSÕES.jpg',
